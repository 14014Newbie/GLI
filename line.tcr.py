...
admins = ["uc77fd25b59f6e563d84f1334f3fed10b"]
Rx5 = ["uc77fd25b59f6e563d84f1334f3fed10b"]
Rx4 = ["uc77fd25b59f6e563d84f1334f3fed10b"]
Rx3 = ["uc77fd25b59f6e563d84f1334f3fed10b"]
Rx2 = ["uc77fd25b59f6e563d84f1334f3fed10b"]
Rx1 = ["uc77fd25b59f6e563d84f1334f3fed10b"]
...
wait = {
    ...
    'timeline':False,
    'autoAdd':False,
    'message':"Thanks add me Owner : http://line.me/ti/p/~ebisuindo",
    "lang":"JP",
    "comment":"Auto like Owner : http://line.me/ti/p/~ebisuindo",
    "likeOn":False,
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                if msg.toType == 2:
                    ...
                    cl.updateGroup(group)
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Url terbuka")
                    else:
                        cl.sendText(msg.to,"Url sudah buka")
                else:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"It can't be used besides the groupã€‚")
                    else:
                    ...
                    cl.updateGroup(group)
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Url Tertutup")
                    else:
                        cl.sendText(msg.to,"Url Sudah tutup")
                else:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"It can't be used besides the groupã€‚")
                    else:
...
#--------------------------------------------------------
                ...
                if wait["leaveRoom"] == True:
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Already aktif")
                else:
                    wait["leaveRoom"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Auto Aktif")
                ...
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"The message was change")
                else:
                           ...
                           pass
                            ...
                            for target in targets:
                                try:
                                    ...
                                    f=codecs.open('st2__b.json','w','utf-8')
                                    json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                    cl.sendText(msg.to,"Yang terdaftar")
                                except:
                                    cl.sendText(msg.to,"Yan terdaftar")
#-----------------------------------------------------------
                  ...
                  if msg.from_ in admin:                                        
                       ...
                       for s in gs.members:
                           if x_name in s.displayName:
                              targets.append(s.mid)
                       if targets == []:
                           cl.sendText(msg.to,"Sukses Hapus")
                           pass
                       else:
                            for target in targets:
                                try:
...
#-----------------------------------------------------------
                ...
                if msg.to in wait['pname']:
                    cl.sendText(msg.to,"PROTECT NAME GROUP")
                else:
                    cl.sendText(msg.to,"Already")
				...
				gid = msg.to
				autocancel[gid] = "poni"
				cl.sendText(msg.to,"Sukses Cancel")
